namespace Kongrevsky.Infrastructure.Impersonator
{
    ...
    public class UserCredentials
    {
        ...
        /// <summary>
        ///     Creates a <see cref="UserCredentials" /> class based on a username and password, where the password is provided as
        ///     a <see cref="SecureString" />.
        ///     The username can contain a domain name if specified in <c>domain\user</c> or <c>user@domain</c> form.
        ///     If no domain is provided, a local computer user account is assumed.
        /// </summary>
        /// <param name="username">The username.</param>
        ...
        /// <summary>
        ///     Creates a <see cref="UserCredentials" /> class based on a domain, username, and password, where the password is
        ///     provided as a <see cref="SecureString" />.
        /// </summary>
        /// <param name="domain">The domain.</param>
        /// <param name="username">The username.</param>
        /// <param name="password">The password.</param>
