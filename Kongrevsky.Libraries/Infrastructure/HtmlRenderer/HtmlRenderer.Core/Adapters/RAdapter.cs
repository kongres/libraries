...
namespace HtmlRenderer.Core.Adapters
{
    ...
    public abstract class RAdapter
    {
        ...
        public RPen GetPen(RColor color)
        {
            ...
            {
                this._penCache[color] = pen = CreatePen(color);
            }
            return pen;
        }
        ...
        public RBrush GetSolidBrush(RColor color)
        {
            ...
            {
                this._brushesCache[color] = brush = CreateSolidBrush(color);
            }
            return brush;
        }
        ...
        public RImage GetLoadingImage()
        {
            ...
            {
                var stream = typeof(HtmlRendererUtils).GetTypeInfo().Assembly.GetManifestResourceStream("HtmlRenderer.Core.Core.Utils.ImageLoad.png");
                if (stream != null)
                    this._loadImage = ImageFromStream(stream);
            }
