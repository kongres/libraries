    ...
    internal sealed class SelectionHandler : IDisposable
    {
        ...
        public void HandleMouseMove(RControl parent, RPoint loc)
        {
            if (this._root.HtmlContainer.IsSelectionEnabled && this._mouseDownInControl && parent.LeftMouseButton)
            {
                ...
                {
                    HandleSelection(parent, loc, !this._isDoubleClickSelect);
            ...
            if (lineBox != null)
            {
                ...
                if (word != null)
                {
                    ...
                    if (CheckNonEmptySelection(loc, allowPartialSelect))
                    {
                        ...
                        SelectWordsInRange(this._root, this._backwardSelection ? this._selectionEnd : this._selectionStart, this._backwardSelection ? this._selectionStart : this._selectionEnd);
                    }
                    else
                    {
                        this._selectionEnd = null;
