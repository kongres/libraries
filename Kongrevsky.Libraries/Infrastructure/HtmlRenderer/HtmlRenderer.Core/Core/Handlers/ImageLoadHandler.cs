...
namespace HtmlRenderer.Core.Core.Handlers
{
    ...
    internal sealed class ImageLoadHandler : IDisposable
    {
        ...
        private void OnHtmlImageLoadEventCallback(string path, object image, RRect imageRectangle)
        {
            if (!this._disposed)
            {
                ...
                if (image != null)
                {
                    ...
                    ImageLoadComplete(this._asyncCallback);
                }
        ...
        {
            this._image = GetImageFromData(src);
            if (this._image == null)
        ...
        private void SetImageFromUrl(Uri source)
        {
            ...
            {
                this._htmlContainer.GetImageDownloader().DownloadImage(source, filePath.FullName, !this._htmlContainer.AvoidAsyncImagesLoading, OnDownloadImageCompleted);
            }
        }
