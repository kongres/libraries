            ...
            try
            {
                ...
                if (rect != null)
                {
                    ...
                    if (link != null)
                    {
                        ...
                        this._contextMenu.AddItem(isVideo ? _openVideo : _openLink, linkExist, OnOpenLinkClick);
                        if (this._htmlContainer.IsSelectionEnabled)
                        {
                            this._contextMenu.AddItem(isVideo ? _copyVideoUrl : _copyLink, linkExist, OnCopyLinkClick);
                        }
                    ...
                    {
                        this._contextMenu.AddItem(_saveImage, rect.Image != null, OnSaveImageClick);
                        if (this._htmlContainer.IsSelectionEnabled)
                        {
                            this._contextMenu.AddItem(_copyImageLink, !string.IsNullOrEmpty(this._currentRect.OwnerBox.GetAttribute("src")), OnCopyImageLinkClick);
                            this._contextMenu.AddItem(_copyImage, rect.Image != null, OnCopyImageClick);
                        }
                        this._contextMenu.AddDivider();
                    }
                    ...
                    if (this._htmlContainer.IsSelectionEnabled)
                    {
                        this._contextMenu.AddItem(_copy, rect.Selected, OnCopyClick);
                    }
                }

                if (this._htmlContainer.IsSelectionEnabled)
                {
                    this._contextMenu.AddItem(_selectAll, true, OnSelectAllClick);
                }
